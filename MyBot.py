        ...
        for planet in planets_by_distance:
            if all_planets_are_owned(game_map):
                ...
                if len(enemy_planets_by_distance) > 0:
                    enqueue_attack_of_docked_ships(command_queue, game_map, enemy_planets_by_distance[0], ship)
                break
...
def enqueue_attack_of_docked_ships(command_queue, game_map, planet, ship):
